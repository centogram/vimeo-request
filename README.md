This is a simple Node.js library for interacting with the [Vimeo API](https://developers.vimeo.com).  This is a stripped version of the video.js without Upload capabilities or any dependency on fs.  It is strictly used to handle requests.
